...
export const DEFAULT_CATEGORIES: AppCategory[] = [
  ...
  { name: 'Shopping', name_zh: '购物消费', icon: '🛍️', color: '#e91e63', type: 'expense', plaidPrimary: ['SHOPS'] },
  { name: 'Entertainment', name_zh: '休闲娱乐', icon: '🎬', color: '#9c27b0', type: 'expense', plaidPrimary: ['ENTERTAINMENT', 'RECREATION'] },
  { name: 'Bills & Utilities', name_zh: '生活缴费', icon: '💡', color: '#ffc107', type: 'expense', plaidPrimary: ['BILLS_AND_UTILITIES'] },
  { name: 'Health', name_zh: '医疗保健', icon: '🏥', color: '#f44336', type: 'expense', plaidPrimary: ['HEALTHCARE'] },
  ...
  { name: 'Transfer', name_zh: '转账', icon: '🔄', color: '#9e9e9e', type: 'transfer', plaidPrimary: ['TRANSFER'] },
  { name: 'Other', name_zh: '其他', icon: '📦', color: '#607d8b', type: 'expense', plaidPrimary: ['OTHER'] },
]
...
export function getCategoryFromPlaid(primary: string | null | undefined): AppCategory {
  ...
  const category = DEFAULT_CATEGORIES.find(c => 
    c.plaidPrimary?.includes(primary.toUpperCase())
  )
